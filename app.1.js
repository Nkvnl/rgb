...
app.post("/send", (req, res) => {
    var output = `
    <h3> Je hebt een nieuw bericht ontvangen via het contactformulier op je website.<h3>
    <h5> Details <h5>
    <ul>
    ...
    let mailOptions = {
        from: '"3DWD" <niekvanlosenoord@gmail.com>', // sender address
        to: 'niek_losenoord@hotmail.com , niekvanlosenoord@gmail.com', // list of receivers
        subject: 'Nieuw bericht via de website', // Subject line
    ...
    transporter.sendMail(mailOptions, (error, info) => {
        ...
        res.render("theme-blue"), res.alert("Bedankt voor uw bericht!");
